...
///////////////////////////////////////////////////////////////
    ...
    //결재관리(상세)
    public Approval_sch getAppDetail(int approval_id){
        return dao.getAppDetail(approval_id);
     }
  //결재관리(수정)
    public String updateApproval(String approval_msg,String approval_type,String status_name,int approval_id){
       int approval_status=0;
       if(status_name.equals("보류"))approval_status=0;
       if(status_name.equals("승인"))approval_status=1;
       if(status_name.equals("반려"))approval_status=2;
        return dao.updateApproval(approval_msg,approval_type,approval_status,approval_id)>0?"수정성공":"수정되지않음";
     }
    //결재관리(삭제)
