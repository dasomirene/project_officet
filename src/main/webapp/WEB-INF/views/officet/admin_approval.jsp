   ...
   $("#schBtn").click(function(){
    ...
    $("#workerUptBtn").click(function(){
          ...
          $("#workerDelBtn").click(function(){
             console.log("확인"+$("#frm [name=approval_id]").val());
             if(confirm("삭제하시겠습니까?")){                
         ...
         */
         $.ajax({
            ...
            success:function(approval){
             ...
             $("#frm [name=status_name]").val(approval.status_name);
             $("#frm [name=approval_id]").val(approval.approval_id);
         ...
         <div id="content">
          ...
          <form method="post" id="schFrm"  class="d-flex align-items-center" >
                   <!-- 팀명 select -->
                     ...
                     <label for="appSelect">승인자명</label> 
                     <select id="appSelect" name="approver">
                     <option value="">전체승인자명</option>
                     </select>
                     ...
                     <label for="reqSelect">요청자명</label> 
                     <select id="reqSelect" name="requester">
                     <option value="">전체요청자명</option>
                     </select>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form id="frm" class="form" method="post">
            결재내용<input type="text" class="form-control" placeholder="결재내용 입력"
               name="approval_msg"><br>
               <label>업무유형</label>
            ...
            <input type="number" class="form-control"    name="approval_id" hidden> <br>
      </form>
               </div>
